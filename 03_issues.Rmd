...
<span class="newthought">As noted previously</span>, estimation of GAMs in the mgcv package is conducted via a penalized likelihood approach. More detail can be found in the [technical section][Technical details], but we should visit a bit directly at least. Conceptually this amounts to fitting the following model:
