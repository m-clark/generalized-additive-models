...
For a fully Bayesian implementation, the <span class="pack">brms</span> package serves as an easy to use starting point in R, and has functionality for using the class="pack">mgcv</span> package's syntax style. The reason is that it just uses mgcv to 
...
```{r bayes-demo-show2, echo=FALSE, eval=FALSE}
library(ggdist)
library(tidybayes)
