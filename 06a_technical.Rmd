...
Workshops see all types of folks at different levels. This is for some of the more technically inclined, though you'll find more context and detail in  and @wood_generalized_2006, from which a good chunk of this section is taken more or less directly from.
...
```{r termplot_gam, dev='svglite', eval=FALSE}
...
```{r termplot_visreg, dev='svglite', echo=-9, eval=FALSE}
