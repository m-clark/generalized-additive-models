...
As we might have expected, there appears to be more color coordination with the MRF result, since neighbors are more likely to be similar.  Meanwhile, the mixed model approach does nothing to correlate one district with the ones it's next to, but may allow for more regularization.
