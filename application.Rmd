...
One can get  sense of the form of the fit by plotting the model object as follows:
...
Note that the plot function will only plot the smooth terms in the model- the others are straight lines since they are linear effects.  The intervals are Bayesian credible intervals based on the posterior predictive distribution. In this single predictor case, one can also revisit the previous graph.  
