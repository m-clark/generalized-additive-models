...
# with(tt, 
#      plot_ly(x=Income, y=Edu,  z=Overall, type='contour', colors=colfun, hoverinfo='none', width='100%', 
#              contours=list(start=240, end=550,size=10)))  %>% 
#   layout(paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)')
with(lapply(tt, round, 2),
     plot_ly(x=Income, y=Edu,  z=Overall, type='heatmap', colors=colfun, width='100%'))  %>%
  layout(paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)')
```
...
colfun = rev(colorRampPalette(RColorBrewer::brewer.pal(9, 'RdBu'))(100))
with(lapply(tt, round, 2), plot_ly(x=Income, y=Edu,  z = Overall, type='heatmap', colors=colfun, width='100%'))  %>% 
  layout(paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)')
with(lapply(tt, round, 2), plot_ly(x=Income, y=Edu,  z = Overall, type='surface', hoverinfo='none', colors=colfun, width='100%',
